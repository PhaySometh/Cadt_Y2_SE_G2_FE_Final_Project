  ...
  return (
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex justify-center items-center z-40"> {/* Changed to z-40 */}
      ...
      >
        ...
        <label className="block mb-1 font-bold text-start">Title</label>
        <input
          type="text"
        ...
        <label className="block mb-1 font-bold text-start">Description</label>
        <textarea
          className="w-full p-2 border mb-3 rounded"
          value={description}
        ...
        <label className="block mb-1 font-bold text-start">Date</label>
        <input
          type="date"
